    ...
    public partial class Form1 : Form
    {
        ...
        private void sepiaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int x = 0; x < loadedImage.Width; x++)
            {
                for (int y = 0; y < loadedImage.Height; y++)
                {
                    ...
                    if (sepiaRed > 255) r = 255;
                    else r = sepiaRed;
                    if (sepiaGreen > 255) g = 255;
                    else g = sepiaGreen;
                    if (sepiaBlue > 255) b = 255;
                    else b = sepiaBlue;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (data != null)
            {
                ...
                else Console.WriteLine("Clipboard data is not a valid image.");
            }
            else Console.WriteLine("Clipboard data is not available.");
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for(int x = 0; x < imageA.Width; x++)
            {
                for (int y=0; y<imageA.Height; y++)
                {
                    ...
                    if(subractionValue > treshold) resultImage.SetPixel(x, y, pixel);
                    else resultImage.SetPixel(x, y, backPixel);
                }
            }
        ...
        //DIP Dynamic Subtraction (Realtime)
